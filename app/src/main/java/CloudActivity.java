package com.sarthak.sarandev.cloudvisionapi;
...
public class CloudActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.sarthak.sarandev.cloudvisionapi.R.layout.activity_cloud);
        Button selectImageButton = (Button) findViewById(com.sarthak.sarandev.cloudvisionapi.R.id
                .select_image_button);
        selectedImage = (ImageView) findViewById(com.sarthak.sarandev.cloudvisionapi.R.id.selected_image);
        resultTextView = (TextView) findViewById(com.sarthak.sarandev.cloudvisionapi.R.id.result);

        selectImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityCompat.requestPermissions(CloudActivity.this,
        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(CloudActivity.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
